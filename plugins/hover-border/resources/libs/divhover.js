  ...
  $.fn.num = function (options) {
    ...
    function num1() {
      ...
      _this.hover(function () {
        ...
        num1 = new than(el)
        num1.thsn()
        _thisTopBottom.animate({
          width: n1 + 3.5,
          opashow
        }, options.speed)
        _thisRightLeft.animate({
          height: h1 + 3.5,
          opashow
        }, options.speed);
      }, function () {
    ...
    function num2() {
      ...
      _this.hover(function () {
        ...
        _thisTop.show().animate({
          left: -80
        }, options.speed).hide(0)
        _thisRight.show().animate({
          top: -80
        }, options.speed).hide(0)
        _thisBottom.show().animate({
          right: -80
        }, options.speed).hide(0)
        _thisLeft.show().animate({
          bottom: -80
        }, options.speed, function () {
          _thisAll.remove()
        }).hide(0);
